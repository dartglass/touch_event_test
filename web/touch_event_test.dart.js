...
$$.Closure$onTouchCancel = {"": "Closure;call$1,$name"};

$$.Closure$onTouchEnd = {"": "Closure;call$1,$name"};
...
main: function() {
  ...
  $.Primitives_printString($.toString$0($.touchEvents));
  var t1 = window;
  $.EventStreamProvider_touchcancel.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_touchcancel._eventType, false);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, $.onTouchCancel$closure, t1._useCapture)._tryResume$0();
  t1 = window;
  $.EventStreamProvider_touchend.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_touchend._eventType, false);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, $.onTouchEnd$closure, t1._useCapture)._tryResume$0();
  t1 = window;
  $.EventStreamProvider_touchmove.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_touchmove._eventType, false);
...
//# sourceMappingURL=touch_event_test.dart.js.map
//@ sourceMappingURL=touch_event_test.dart.js.map
